...
sspl_R <- smooth.spline(dA$time, dA$Humidity, df=80)
sspl_A <- smooth.spline(dA$time, dA$Temperature, df=21)
sspl_A2 <- smooth.spline(dL$time, dL$Tair, df=207)
sspl_E <- smooth.spline(dL$time, dL$Treflect, df=207)
