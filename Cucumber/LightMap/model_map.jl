...
const tON = ("01:20:00 PM",
             "01:24:00 PM",
             "01:28:00 PM",
             "01:32:00 PM",
             "01:36:00 PM")

const t0s = DateTime("21/12/2022 01:17:53 PM", dateformat"d/m/y H:M:S p")
const t0c = DateTime("21/12/2022 12:49:22 PM", dateformat"d/m/y H:M:S p")
const tst = DateTime("21/12/2022 01:20:00 PM", dateformat"d/m/y H:M:S p")
...
function Load_temps()
    ...
    ID = parse.(Int64, FN)
    sID = sort(ID)
    files = [files[pos] for pos in [findall(x -> x == i, ID)[1] for i in sID]]
...
function Run()
    ...
    plot(hm, size=(new_width, new_height), dpi=dpi)

savefig("Lightmap.png")
